...
class UniformsMaskedPhoneField extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { showMenu, regionFieldName } = _a, props = __rest(_a, ["showMenu", "regionFieldName"]);
            ...
            this.state.disabled ? null :
                React.createElement(uniforms_material_1.TextField, Object.assign({}, props, { inputProps: { mask: this.state.mask }, InputProps: {
                        ...
                        startAdornment: this.props.showMenu ? (React.createElement(core_1.InputAdornment, { position: "start" },
                            ...
                            React.createElement(core_1.Menu, { id: "Lang-manu", anchorEl: anchorEl, open: Boolean(anchorEl), onClose: this.handleClose, PaperProps: {
                                    style: {
                                        maxHeight: 216,
                                        width: 200,
                                    },
