...
class UniformsMaskedPhoneField extends React.Component {
    ...
    render() {
        ...
        return React.createElement("span", null, this.state.disabled ? null : React.createElement("span", null,
            React.createElement(uniforms_material_1.TextField, Object.assign({}, props, { inputProps: { mask: this.state.mask }, InputProps: {
            ...
            React.createElement(uniforms_material_1.TextField, { name: this.props.regionFieldName, inputProps: { type: 'hidden' }, value: this.state.lang })));
    }
}
